...
class StudentController {
  async createStudent(req, res, next) {
    ...
    try {
      ...
      await sendMail({
        to: req.body.email,
        subject: `Welcome to SRMS Library Management System - Password Reset Required`,
        text: `Dear ${req.body.name},
                    Welcome to the SRMS Library Management System! Your account has been created by our admin.
                    Login Credentials:
                    Username/Email: ${req.body.email}
                    Default Password: ${password}
                    You can change your password by login into the system by using above credentials.
                    Thank you for using SRMS Library Management System.
                    `,
      });
    } catch (error) {
      return next(error);
