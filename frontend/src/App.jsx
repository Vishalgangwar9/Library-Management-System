...
const App = () => {
  ...
  // Refresh token request to keep user logged in even after a page refresh
  useEffect(() => {
      ...
      <Routes>
        ...
        <Route path="/admin" element={<AdminProtectedRoutes />}>
          <Route path="dashboard" element={<AdminDashboardLayout />}>
            ...
            <Route path="manage-renew-requests" element={<ManageRenewRequests />} />
            <Route path="manage-messages" element={<ManageMessages />} />
            {/* AUTH ROUTES */}
            <Route path="profile" element={<Profile />} />
            <Route path="change-password" element={<ChangePassword />} />
            {/* CLEARANCE FORM ROUTE */}
            <Route path="manage-clearance-form/:status" element={<ManageClearanceRequest />} />
          </Route>
        </Route>
...
export const AdminProtectedRoutes = () => {
  ...
  return auth?.isAuth && auth.user?.role === "Admin" ? <Outlet /> : <Navigate to="/login" />;
};
